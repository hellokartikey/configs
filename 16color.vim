...
" Author: kartikey, itchyny, jackno
" License: MIT License
" =============================================================================

let s:background = [ '#000000', 236 ]
...
let s:p.inactive.middle = [ [ s:silver, s:background ] ]
...
let s:p.tabline.middle = [ [ s:silver, s:background ] ]
